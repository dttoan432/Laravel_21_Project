...
Route::get('login/admin', 'Auth\LoginController@showLoginFormAdmin')->name('login');
...
Route::group([
    ...
    Route::post('/option', 'DashboardController@option')->name('backend.option');
    ...
    Route::group(['prefix' => 'user'], function () {
        ...
        Route::get('/{user}', 'UserController@show')->name('backend.user.show');
